...
public class FooterLine {
    public FooterLine(PdfPTable table, int startCell, String label, String value) throws AssertionError {
        ...
        PdfPCell valueCell = new PdfPCell(new Phrase(value, new Font(Font.FontFamily.UNDEFINED, 6)));
