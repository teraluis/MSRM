...
public class IncompleteIntervention extends ScheduledIntervention {

    public final List<String> bills;

    @JsonCreator
    public IncompleteIntervention(
        ...
        super(id, name, status, createdBy, createDate, estateAddress, prestations, parameters, planning, comments);
        this.bills = bills;
    }
}
